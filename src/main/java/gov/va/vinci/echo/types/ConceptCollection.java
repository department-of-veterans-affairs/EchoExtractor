 ...
 * @generated */
public class ConceptCollection extends Regex {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ConceptCollection.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ConceptCollection() {/* intentionally empty block */}
   ...
   */
  public ConceptCollection(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public ConceptCollection(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public ConceptCollection(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
