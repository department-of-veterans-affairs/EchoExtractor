 ...
 * @generated */
public class Relation3 extends Relation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Relation3.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Relation3() {/* intentionally empty block */}
   ...
   */
  public Relation3(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Relation3(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
