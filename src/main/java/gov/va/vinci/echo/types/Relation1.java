...
public class Relation1 extends Relation {
  ...
  public final static int typeIndexID = JCasRegistry.register(Relation1.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Relation1() {/* intentionally empty block */}
   ...
   */
  public Relation1(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Relation1(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
