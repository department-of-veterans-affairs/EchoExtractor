...
public class Mapping extends Annotation {
  ...
  */  
  public Mapping(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
  ...
  public StringArray getMapping() {
    if (Mapping_Type.featOkTst && ((Mapping_Type)jcasType).casFeat_Mapping == null)
      jcasType.jcas.throwFeatMissing("Mapping", "gov.va.vinci.echo.types.Mapping");
    return (StringArray)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Mapping_Type)jcasType).casFeatCode_Mapping)));}
  ...
  public void setMapping(StringArray v) {
    if (Mapping_Type.featOkTst && ((Mapping_Type)jcasType).casFeat_Mapping == null)
      jcasType.jcas.throwFeatMissing("Mapping", "gov.va.vinci.echo.types.Mapping");
    jcasType.ll_cas.ll_setRefValue(addr, ((Mapping_Type)jcasType).casFeatCode_Mapping, jcasType.ll_cas.ll_getFSRef(v));}    
  ...
  public String getMapping(int i) {
    if (Mapping_Type.featOkTst && ((Mapping_Type)jcasType).casFeat_Mapping == null)
      jcasType.jcas.throwFeatMissing("Mapping", "gov.va.vinci.echo.types.Mapping");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((Mapping_Type)jcasType).casFeatCode_Mapping), i);
    return jcasType.ll_cas.ll_getStringArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((Mapping_Type)jcasType).casFeatCode_Mapping), i);}
  ...
  public void setMapping(int i, String v) { 
    if (Mapping_Type.featOkTst && ((Mapping_Type)jcasType).casFeat_Mapping == null)
      jcasType.jcas.throwFeatMissing("Mapping", "gov.va.vinci.echo.types.Mapping");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((Mapping_Type)jcasType).casFeatCode_Mapping), i);
    jcasType.ll_cas.ll_setStringArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((Mapping_Type)jcasType).casFeatCode_Mapping), i, v);}
  }
