 ...
 * @generated */
public class Method extends Regex {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Method.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Method() {/* intentionally empty block */}
   ...
   */
  public Method(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Method(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
