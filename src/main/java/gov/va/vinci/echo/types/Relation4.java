 ...
 * @generated */
public class Relation4 extends Relation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Relation4.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Relation4() {/* intentionally empty block */}
   ...
   */
  public Relation4(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Relation4(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
