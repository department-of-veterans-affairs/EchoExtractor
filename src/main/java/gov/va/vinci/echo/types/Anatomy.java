 ...
 * @generated */
public class Anatomy extends Regex {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Anatomy.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Anatomy() {/* intentionally empty block */}
   ...
   */
  public Anatomy(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Anatomy(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
