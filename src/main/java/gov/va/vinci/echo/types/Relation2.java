...
public class Relation2 extends Relation {
  ...
  public final static int typeIndexID = JCasRegistry.register(Relation2.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Relation2() {/* intentionally empty block */}
   ...
   */
  public Relation2(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Relation2(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
